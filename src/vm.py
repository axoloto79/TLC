    ...
    def run(self):
        ...
        while self.pc < len(self.instructions):
            ...
            if op == "debutProg":
                ...
                self.stack[-1] = -self.stack[-1] # inverse le signe de la valeur
            ...
            ##Passage aux instructions NNP
                ...
                self.base = len(self.stack) - nbp - 2 # mets à jour la base du bloc de liaison
                self.stack[self.base + 1] = self.pc # mets à jour l'adresse de retour
